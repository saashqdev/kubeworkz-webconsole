...
func (c *kubeLogger) Info(format string, a ...interface{}) {
	c.l.Info(fmt.Sprintf(format, a...))
}

func (c *kubeLogger) Warn(format string, a ...interface{}) {
	c.l.Warn(fmt.Sprintf(format, a...))
}

func (c *kubeLogger) Error(format string, a ...interface{}) {
	c.l.Error(fmt.Sprintf(format, a...))
}

func (c *kubeLogger) Fatal(format string, a ...interface{}) {
...
// levelAdapt adapts kube logger level to zap logger level
